/**
* @overview The Unread Message Counts Plugin allows you to count the number of unread messages. <br><img src="plugins/chat-engine-unread-messages/output.gif" height="400"></img>
